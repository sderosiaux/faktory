...
func TestNamespaceFactIsolation(t *testing.T) {
	...
	s.InsertFact("alice", "work", "uses Go at work", "h1", emb, 3, "", 0)
	s.InsertFact("alice", "personal", "likes cooking at home", "h2", emb, 3, "", 0)
	s.InsertFact("alice", "", "general fact", "h3", emb, 3, "", 0)
...
func TestNamespaceSearchIsolation(t *testing.T) {
	...
	s.InsertFact("alice", "work", "uses Go", "h1", []float32{1, 0, 0, 0}, 3, "", 0)
	s.InsertFact("alice", "personal", "likes cooking", "h2", []float32{1, 0, 0, 0}, 3, "", 0)
...
func TestNamespaceDeleteAll(t *testing.T) {
	...
	s.InsertFact("alice", "work", "work fact 1", "wh1", emb, 3, "", 0)
	s.InsertFact("alice", "work", "work fact 2", "wh2", emb, 3, "", 0)
	s.InsertFact("alice", "personal", "personal fact", "ph1", emb, 3, "", 0)
...
func TestNamespaceRecall(t *testing.T) {
	...
	s.InsertFact("alice", "work", "uses Go at work", "wh1", workEmb, 3, "", 0)
	s.InsertFact("alice", "personal", "likes cooking", "ph1", personalEmb, 3, "", 0)
...
func TestNamespaceHashDedup(t *testing.T) {
	...
	emb := []float32{0.1, 0.2, 0.3, 0.4}
	s.InsertFact("alice", "work", "likes pizza", "same_hash", emb, 3, "", 0)
...
func TestNamespacePruneHistory(t *testing.T) {
	...
	s.InsertFact("alice", "work", "work fact", "wh1", emb, 3, "", 0)
	s.InsertFact("alice", "personal", "personal fact", "ph1", emb, 3, "", 0)
